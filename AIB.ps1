##################################################################
# Set Permissions & Create Resurce group for Image Builder Images
##################################################################
...
$templateUrl="https://raw.githubusercontent.com/virtualosityinc/BNPRCCTEST-AIB/master/helloImageTemplateWin01.json"
...
New-AzResourceGroupDeployment -ResourceGroupName $imageResourceGroup -TemplateFile $templateFilePath -apiversion "2019-05-01-preview" -imageTemplateName $imageTemplateName -svclocation $location
